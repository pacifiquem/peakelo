...
type PolymorphicComponentPropWithRef<T extends React.ElementType, Props = object> =
...
export type PolymorphicComponentProps<T extends React.ElementType, P = object> =
